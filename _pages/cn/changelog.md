...
发布日期：2026-07-20 (build 277)

- 修正: 修正默认播放器播放 Emby 选择的外挂 ASS 字幕时出现乱码的问题

注意：在未来的版本中我们会停止对iOS 15的支持，这是最后支持iOS 15的一个版本


## **Version 1.4.12**

发布日期：2026-07-02 (build 276)

- 修正: 修正无法添加123云盘的问题
- 修正: 修正字幕延迟每次都是从0开始调整的问题

注意：在未来的版本中我们会停止对iOS 15的支持，这是最后支持iOS 15的一个版本

## **Version 1.4.11**

发布日期：2026-07-01 (build 275)

- 优化: 播放Emby剧集下一集时自动选择之前的视频版本信息
- 修正: 修正Emby详情页面选择视频版本可能被重置的问题
- 修正: 修正音频播放器暂停后系统正在播放中心进度显示异常的问题
- 修正: 修正音频播放器播放部分音频可能会等很久才播放下一首的问题
...
发布日期：2026-06-06 (build 273)

- 修正: 修正iOS 26系统本地文件与云端文件列表第一个文件无法点击的问题
- 修正: 修正Emby季详情页面可能无法加载剧集列表的问题
- 修正: 修正无法播放123云盘视频的问题

## **Version 1.4.9**

发布日期：2026-06-05 (build 272)

- 新增: Emby 剧集详情页面增加滑动加载更多剧集
- 优化: 优化Emby媒体库更新时页面会乱跳的问题
- 优化: 优化Emby详情页面海报
- 优化: 优化画中画性能
- 修正: 修正加载字幕可能会卡一下的问题
- 修正: 修正阿里云盘refresh token过期后无法打开阿里云盘的问题
- 修正: 修正123云盘授权过期后没有弹出再次授权页面的问题
- 修正: 修正SMB 无法重命名的问题

## **Version 1.4.8**

发布日期：2026-03-16 (build 271)

- 优化: 优化Emby列表 在iPad 下的显示
- 修正: 修正应用锁开启时文件仍在系统文件应用中可见的问题
- 修正: 修正开启综合搜索后，点击搜索结果再次返回后选中的Tab不对的问题

## **Version 1.4.6**

发布日期：2026-01-31 (build 269)

- 修正: 修正默认播放器加载外部ASS字幕显示为口的问题 

## **Version 1.4.5**

发布日期：2025-12-4 (build 267)

- 修正: 修正默认播放器字幕显示为口的问题
- 修正: 修正本地XML弹幕文件没有自动加载的问题

## **Version 1.4.4**

发布日期：2025-12-3 (build 266)

- 新增: 新增VTT字幕格式支持
- 新增: iOS 18.4 以上支持ASS字幕样式
- 修正: 修正投屏无法搜索到设备的问题

## **Version 1.4.3**

发布日期：2025-11-21 (build 265)

- 新增: 115云盘新增文件上传功能
- 新增: 123云盘新增文件上传功能
- 修正: 修正从Emby聚合搜索观看视频会在连接创建所有结果连接的问题
- 移除: 移除EPUB预览支持，使用系统分享打开EPUB文件


## **Version 1.4.1**

发布日期：2025-11-9 (build 263)

- 新增: 连接新增上次播放时间显示
- 优化: 关闭播放器增加动画
- 优化: 添加忽略ASS样式开关
- 修正: 修正iOS 26上Emby视频版本选择无法滑动的问题 
- 修正: 移除搜索框背景颜色
- 修正: 修正浏览图片长按保存云端图片不对的问题


## **Version 1.4.0**

发布日期：2025-10-14 (build 262)

- 适配: 适配iOS 26
- 修正: 修正部分STRM Emby 视频无法播放的问题


## **Version 1.3.44**

发布日期：2025-09-23 (build 261)

- 新增: 新增Emby弹幕插件raw接口支持
- 修正: 修正中文字幕可能显示为口的问题
- 修正: 修正iPad左侧快捷连接可以无须解锁密码就可以访问的问题
- 修正: 修正Emby STRM格式视频进度上报错误的问题
- 移除: 移除Google Drive支持
...
- 新增: 音频播放器睡眠模式新增播放完当前音频自动关闭的功能
- 新增: 新增opus音频格式支持
- 修正: 修正PDF浏览模式

## **Version 1.3.41**

发布日期：2025-05-27 (build 258)

- 新增: 新增本地txt文件转epub的功能
- 修正: 修正解锁密码不对其他连接生效的问题
- 修正: 修正无法编辑解锁密码的问题
- 修正: 修正部分WebDAV 视频无法播放的问题
- 修正: 修正在Emby首页切换Emby不需要输入解锁密码的问题

## **Version 1.3.40**

发布日期：2025-05-22 (build 257)

- 新增: 新增epub、cbz格式支持
- 优化: 优化本地浏览图片用户体验
- 优化: 优化浏览阿里云盘、115、OneDrive图片用户体验
- 修正: 修正OneDrive点击后可能提示错误的问题
- 修正: 修正部分WebDAV 视频无法播放的问题


## **Version 1.3.39**

发布日期：2025-05-08 (build 256)
...
- 优化: 优化Emby搜索用户体验
- 优化: Emby详情页面Logo可点击
- 修正: 修正115云盘全局搜索结果无法跳转到对应文件夹的问题
- 修正: 修正Emby首页合集数据源问题
- 修正: 修正剧集无Logo时Emby详情页在iPad设备上的显示问题
- 修正: 修正Emby音乐专辑封面显示问题


## **Version 1.3.38**

发布日期：2025-04-22 (build 255)

- 新增: Emby 设置页面新增显示电影、节目、剧集个数
- 修正: 修正115云盘提示access token失效的问题
- 修正: 修正部分Emby 电视剧详情页面点击播放按钮没有反应的问题
- 修正: 修正Alist SSL错误导致无法连接的问题
- 修正: 修正无法播放Google Drive音频的问题


## **Version 1.3.37**

发布日期：2025-04-01 (build 253)

- 新增: 123云盘新增日期显示
- 修正: 修正部分pCloud用户无法登录的问题
- 修正: 修正pCloud上传文件始终传到根目录的问题
- 修正: 修正删除pCloud文件夹提示文件夹不为空的问题
- 修正: 修正123云盘授权到期没有自动刷新的问题

## **Version 1.3.36**

发布日期：2025-03-21 (build 252)

- 新增: 新增5个元素本地弹幕格式支持
- 修正: 修正飞牛OS视频无法播放的问题
- 修正: 修正Emby详情页在iPad上的显示问题
- 修正: 修正无法选择默认图标的问题

## **Version 1.3.35**

发布日期：2025-03-10 (build 251)
...
发布日期：2025-02-27 (build 249)

- 新增: 新增115网盘支持
- 新增: 新增123云盘支持
- 新增: 新增strm文本格式支持
- 修正: 修正调整音频播放器速度后菜单没有更新的问题


## **Version 1.3.32**

发布日期：2025-02-12 (build 248)

- 优化: VLC 降级为 3.6.0 版本
- 修正: 修正Alist协议无法使用IPv6地址的问题

## **Version 1.3.31**

发布日期：2025-01-31 (build 247)

- 新增: 默认播放器新增画中画功能
- 优化: 优化投屏用户体验
- 优化: VLC 升级为 4.0 版本
- 修正: 修正弹幕无法搜索的问题
- 修正: 修正播放全局搜索出来的视频无法匹配到字幕的问题

## **Version 1.3.30**

发布日期：2024-12-15 (build 246)

- bug修复与性能优化

## **Version 1.3.29**

发布日期：2024-11-23 (build 245)

- 新增: MPV 播放器新增AV1解码支持
- 新增: Emby 新增随机排序功能
- 新增: 云端搜索结果新增长按重命名功能
- 修正: 修正 iPadOS 18 下Emby详情页无法滑动到底部的问题
- 修正: 修正切换下一个视频会导致无法选择Emby视频版本的问题
- 修正: 修正本地文件搜索在iOS 18 上显示异常的问题
- 修正: 修正新建文件夹在iPad横屏模式下的显示问题

## **Version 1.3.28**

发布日期：2024-10-12 (build 244)
...
发布日期：2024-10-02 (build 243)

- 修正: 修正WiFi传输文件屏幕会熄屏的问题
- 修正: 修正播放器字幕延迟调节无法是负数的问题
- 修正: 修正修改弹幕自定义地址后下次启动不生效的问题
- 修正: 修正播放本地视频无法自动加载字幕的问题

## **Version 1.3.26**

发布日期：2024-07-28 (build 241)
