...
- 新增: iPad 播放器新增外接键盘快捷键（长按Command键查看说明）
...
- 优化: 去掉批量重命名的格式化添加的空格
- 优化: 优化 SMB 缩略图缓存
- 修正: 修正夸克云盘/115云盘在iPad下没有导航栏的问题
- 修正: 修正某些 M3U 文件无法正常解析的问题
- 修正: 修正天翼云盘（家庭版）无法点击的问题
...
- 新增: 新增天翼云盘支持
- 新增: PikPak 新增图片、视频预览图功能
- 修正: 修正点击投屏可能崩溃的问题
- 修正: 修正投屏搜索结果可能看不清的问题
- 修正: 修正115/PikPak/Quark 网盘视频无法在媒体库恢复播放的问题
- 修正: 修正MPV拖动进度时进度条会乱跳的问题
- 修正: 修正115网盘MP4文件无法使用系统播放器的问题
- 修正: 修正115网盘MP4无法开启小窗播放的问题
...
- 修正: 修正115网盘无法查看图片的问题
- 修正: 修正115网盘无法移动文件的问题
- 修正: 修正115网盘搜索结果文件大小显示不正确的问题
- 修正: 修正PikPak网盘无法移动文件的问题
