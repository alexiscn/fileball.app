...
發布日期：2026-07-20 (build 277)

- 修正：修正預設播放器播放 Emby 選擇的外掛 ASS 字幕時出現亂碼的問題

注意：在未來的版本中我們會停止對iOS 15的支持，這是最後支援iOS 15的一個版本

## **Version 1.4.12**

發布日期：2026-07-02 (build 276)

- 修正: 修正無法新增123雲端碟的問題
- 修正: 修正字幕延遲每次都是從0開始調整的問題

注意：在未來的版本中我們會停止對iOS 15的支持，這是最後支援iOS 15的一個版本

## **Version 1.4.11**

發布日期：2026-07-01 (build 275)

- 優化: 播放Emby劇集下一集時自動選擇先前的視訊版本訊息
- 修正: 修正Emby詳情頁面選擇影片版本可能被重置的問題
- 修正: 修正音訊播放器暫停後系統正在播放中心進度顯示異常的問題
- 修正: 修正音訊播放器播放部分音訊可能會等很久才播放下一首的問題

注意：在未來的版本中我們會停止對iOS 15的支持，這是最後支援iOS 15的一個版本

## **Version 1.4.10**

發布日期：2026-06-06 (build 273)

- 修正: 修正iOS 26系統本機檔案與雲端檔案清單第一個檔案無法點擊的問題
- 修正: 修正Emby季詳情頁面可能無法載入劇集清單的問題
- 修正: 修正無法播放123雲盤影片的問題

## **Version 1.4.9**

發布日期：2026-06-05 (build 272)

- 新增: Emby 劇集詳情頁面增加滑動加載更多劇集
- 優化: 優化Emby媒體庫更新時頁面會亂跳的問題
- 優化: 優化Emby詳情頁面海報
- 優化: 優化畫中畫性能
- 修正: 修正載入字幕可能會卡一下的問題
- 修正: 修正阿里雲盤refresh token過期後無法打開阿里雲盤的問題
- 修正: 修正123雲盤授權過期後沒有彈出再次授權頁面的問題
- 修正: 修正SMB 無法重命名的問題

## **Version 1.4.8**

發布日期：2026-03-16 (build 271)

- 優化: 優化Emby列表 在iPad 下的顯示
- 修正: 修正應用鎖開啟時文件仍在系統文件應用中可見的問題
- 修正: 修正開啟綜合搜索後，點擊搜索結果再次返回後選中的Tab不對的問題

## **Version 1.4.6**

發佈日期：2026-01-31 (build 269)

- 修正: 修正預設播放器載入外部ASS字幕顯示為口的問題

## **Version 1.4.5**

發佈日期：2025-12-4 (build 267)

- 修正：修正預設播放器字幕顯示為「口」的問題
- 修正：修正本地 XML 彈幕檔案未自動載入的問題

## **Version 1.4.4**

發佈日期：2025-12-3 (build 266)

- 新增：新增 VTT 字幕格式支援
- 新增：iOS 18.4 以上支援 ASS 字幕樣式
- 修正：修正投屏無法搜尋到裝置的問題


## **Version 1.4.3**

發佈日期：2025-11-21 (build 265)

- 新增：115 雲盤新增檔案上傳功能
- 新增：123 雲盤新增檔案上傳功能
- 修正：修正從 Emby 聚合搜尋觀看影片時，在連線時會為所有結果建立連線的問題
- 移除：移除 EPUB 預覽支援，改為使用系統分享/開啟功能打開 EPUB 檔案


## **Version 1.4.1**

發佈日期：2025-11-09 (build 263)

- 新增: 連線列表新增上次播放時間顯示
- 優化: 關閉播放器時增加動畫效果
- 優化: 新增忽略ASS樣式的開關
- 修正: 修正iOS 26上Emby影片版本選擇無法滑動的問題
- 修正: 移除搜尋框背景顏色
- 修正: 修正圖片瀏覽器中長按儲存雲端圖片不正確的問題


## **Version 1.4.0**

發佈日期：2025-10-14 (build 262)

- 適配: 適配iOS 26
- 修正: 修正部分STRM Emby 影片無法播放的問題


## **Version 1.3.44**

發佈日期：2025-09-23 (build 261)

- 新增: 新增Emby彈幕外掛程式raw介面支持
- 修正: 修正中文字幕可能顯示為口的問題
- 修正: 修正iPad左側快捷連線可以無須解鎖密碼就可以存取的問題
- 修正: 修正Emby STRM格式影片進度上報錯誤的問題
- 移除: 移除Google Drive支持

## **Version 1.3.43**

發佈日期：2025-08-11 (build 260)
...
- 新增: 新增音訊播放器睡眠模式新增播放完當前音訊自動關閉的功能
- 新增: 新增opus音訊格式支援
- 修正: 修正PDF瀏覽模式

## **Version 1.3.41**

發佈日期：2025-05-27 (build 258)
